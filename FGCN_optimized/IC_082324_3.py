...
val_data = val_csv.sample(frac=0.5)
...
for i in range(n_formaulatants):
    ...
    model_molecule[f"modelmolecule{i}"].load_weights('/u/murtazaz/ionic_cond/082324/checkpointhlem/my_checkpoint')
